...
const atokens = {
  ...
  aknc: ['0x39C6b3e42d6A679d7D776778Fe880BC9487C2EDA', primitives.kncl],
...
const mainnetConfig = {
  ...
  curve: {
    ...
    pools: {
      '3pool': {
        ...
        liquidityGaugeToken: ethers.constants.AddressZero,
  ...
  paraSwapV5: {
    ...
    feePartner: ethers.constants.AddressZero,
    feePercent: 0,
    tokenTransferProxy: '0x216B4B4Ba9F3e719726886d34a177484278Bfcae',
  },
  poolTogetherV4: {
    ptTokens: {
      ptUsdc: ["0xdd4d117723C257CEe402285D3aCF218E9A8236E1", primitives.usdc]
    }
  },
  positionsLimit: 20,
  primitives,
