...
const primitives = {
  // '1inch': '0x9c2c5fd7b07e95ee044ddeba0e97a665f142394f', // OK
  // aave: '0xD6DF932A45C0f255f85145f286eA0b292B21C90B', // OK
  // // alcx: '',
  // // axs: '',
  // // badger: '',
  // bal: '0x9a71012b13ca4d3d0cdc72a177df3ef03b0e76a3', // OK
  // bat: '0x3cef98bb43d732e2f285ee605a8158cde967d219', // OK
  // // bnt: '',
  // // bond: '',
  // bzrx: '0x54cfe73f2c7d0c4b62ab869b473f5512dc0944d2', // KO
  // cel: '0xd85d1e945766fea5eda9103f918bd915fbca63e6', // OK
  // // chz: '',
  // comp: '0x8505b9d2254a7ae468c0e9dd10ccea3a837aef5c', // OK
  // crv: '0x172370d5cd63279efa6d502dab29171933a610af', // OK
  // dai: '0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063', // OK
  // // dodo: '',
  // // dpi: '',
  // enj: '0x7ec26842f195c852fa843bb9f6d8b583a274a157', // KO ?
  // // farm: '',
  // frax: '0x45c32fa6df82ead1e2ef74d17b76547eddfaff89', // OK
  // fxs: '0x1a3acf6d19267e2d3e7f898f42803e90c9219062', // OK
  // ghst: '0x385eeac5cb85a38a9a07a70c73e0a3271cfb54a7', // OK
  // knc: '0x1c954e8fe737f99f68fa1ccda3e51ebdb291948c', // OK
  // link: '0x53e0bca35ec356bd5dddfebbd1fc0fd03fabad39', // OK
  // // lpt: '',
  // mana: '0xa1c57f48f0deb89f569dfbe6e2b7f46d33606fd4',
  // // mft: '',
  // mkr: '0x6f7C932e7684666C9fd1d44527765433e01fF61d', // OK
  // nexo: '0x41b3966b4ff7b427969ddf5da3627d6aeae9a48e', // OK
  // // ohm: '',
  // // omg: '',
  // // pax: '',
  // // paxg: '',
  // quick: '0x831753dd7087cac61ab5644b308642cc1c33dc13', // OK
  // // rep: '',
  // snx: '0x50b728d8d964fd00c2d0aad81718b71311fef68a', // KO
  // sushi: '0x0b3f868e0be5597d5db7feb59e1cadbb0fdda50a', // KO
  // uma: '0x3066818837c5e6ed6601bd5a91b0762877a6b731', // KO
  // uni: '0xb33eaad8d922b1083446dc23f610c2567fb5180f', // KO
  // usdc: '0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174', // KO
  // usdt: '0xc2132D05D31c914a87C6611C10748AEb04B58e8F', // KO
  // wbtc: '0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6', // KO
  // wmatic, // OK
  // // xsushi: '',
  // yfi: '0xda537104d6a5edd53c6fbba9a898708e465260b6', // OK
  // // zrx: '',
};
...
const atokens = {
  aaave: ['0x1d2a0E5EC8E5bBDCA5CB219e649B565d8e5c3360', primitives.aave],
  adai: ['0x27F8D03b3a2196956ED754baDc28D73be8830A6e', primitives.dai],
  ausdc: ['0x1a13F4Ca1d028320A707D99520AbFefca3998b7F', primitives.usdc],
  ausdt: ['0x60D55F02A771d515e077c9C2403a1ef324885CeC', primitives.usdt],
  awbtc: ['0x5c2ed810328349100A66B82b78a1791B101C9D61', primitives.wbtc],
  aweth: ['0x28424507fefb6f7f8E9D3860F56504E4e5f5f390', weth],
  awmatic: ['0x8dF3aad3a84da6b69A4DA8aeC3eA40d9091B2Ac4', primitives.wmatic],
};
...
const polygonConfig = {
  ...
  curve: {
    ...
    minter: ethers.constants.AddressZero, // Minter only exists on Ethereum mainnet
  ...
  poolTogetherV4: {
    ptTokens: {
      ptUsdc: ['0x6a304dFdb9f808741244b6bfEe65ca7B3b3A6076', primitives.usdc]
    }
  },
  positionsLimit: 20,
  primitives,
